...
namespace Shipping
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Enter to exist Shipping");
            Console.ReadLine();
        }

        private static IEndpointInstance ConfigureNServiceBus()
        {
            var assemblyName = "Application.Shipping";
            ...
            routing.RouteToEndpoint(typeof(CompleteShipment).Assembly, "Application.Client");
