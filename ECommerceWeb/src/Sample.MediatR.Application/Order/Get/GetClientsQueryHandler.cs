...
public class GetOrderQueryHandler : IRequestHandler<GetOrderQuery, Domain.Order>
{
    ...
    public async Task<Domain.Order> Handle(GetOrderQuery request, CancellationToken cancellationToken)
    {
